...
Если есть вопросы, напиши "Нужна помощь"
""")


""" Обработчик кнопки меню"""
@router.callback_query(F.data == "webapppril")
async def main_menu_but(callback: CallbackQuery):
    await callback.answer('') # Чтобы кнопка не светилась после нажатия
...
""" Обработчик сообщения "Нужная помощь" """
